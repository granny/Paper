...
public class EntityTypeRewriter extends EnumRegistryRewriter<EntityType<?>> {
    ...
    record Data(ClassNamed api, int legacyId) {
        ...
        public static final Codec<Data> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            CodecUtil.CLASS_NAMED.fieldOf("api").forGetter(Data::api),
            ExtraCodecs.POSITIVE_INT.optionalFieldOf("legacy_id", -1).deprecated(13).forGetter(Data::legacyId)
        ).apply(instance, Data::new));

        private static final Codec<Data> CLASS_ONLY_CODEC = CodecUtil.CLASS_NAMED.xmap(Data::new, Data::api);
